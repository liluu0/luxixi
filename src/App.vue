...
<template><CityHeatmap v-if="path==='/works/city-heatmap'" :on-back="closeWork"/><CastleBattle v-else-if="path==='/works/castle-battle'" :on-back="closeWork"/><HomePage v-else :on-open="openWork" :on-open-castle="openCastle"/></template>
